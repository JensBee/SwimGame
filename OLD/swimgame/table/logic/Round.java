...
public class Round implements Iterator<Integer> {
    ...
    /** The current {@link CardPlayer}. */
    private CardPlayer currentPlayer;
    /** The {@link CardPlayer} who called closing this round. */
    private CardPlayer closingPlayer;
    ...
    /**
     * Set the current active {@link CardPlayer}.
     * 
     * @param playerToSet
     *            {@link CardPlayer} to set as current
     */
    final void setCurrentPlayer(final CardPlayer playerToSet) {
	byte i = 0;
	for (CardPlayer player : this.table.player.asList()) {
     ...
     * 
     * @return The {@link CardPlayer} who is starting this new round
     */
    public final CardPlayer nextPlayer() {
	this.currentPlayer = this.players.next();
     ...
     * 
     * @param player
     *            The {@link CardPlayer} to test
     * @return True if the given player has closed this round
     */
    public final boolean isClosedBy(final CardPlayer player) {
     ...
     * 
     * @return The {@link CardPlayer} whos turn is current
     */
    public final CardPlayer getCurrentPlayer() {
	return this.currentPlayer;
    }
    ...
    public void finish() {
	this.table.player.fireEvent(TableLogic.Event.ROUND_FINISHED);
    }
}
