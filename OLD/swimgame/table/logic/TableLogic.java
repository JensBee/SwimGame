...
public class TableLogic {
    ...
    /** Possible events a player can handle during the game. */
    ...
    public enum Action implements CardGameEvent {
	/**
	...
	// three of a color?
	cardsCount = 0;
	for (CardDeck.Card card : CardStack
		.getCardsByColor(cards[0].getColor())) {
	...
	this.tableController.handleEvent(action, data);
    }
